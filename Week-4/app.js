...
studentGrades.forEach(function (currentStudent, currentStudentIndex) {
  ...
  printAnswer(currentStudent[currentStudentIndex]);
});
...
// 1. Show full name
document.getElementById("fullName").innerHTML += personalbar.getFullName();
...
document.getElementById("newProp").innerHTML += `<br /> ${JSON.stringify(
  person
)}`;
